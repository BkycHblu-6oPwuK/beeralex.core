<?
/**
 * Файл для отображения страницы настроек модуля в административной части
 * Поддерживает загрузку схемы настроек из самого модуля и/или из локальной папки, что позволяет добавлять настройки без изменения кода модуля
